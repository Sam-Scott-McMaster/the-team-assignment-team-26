 ...
 * 
 * DISCLAIMER: This is a modified game of the original memory match game in order to 
 * run the test script and generate the .gcov coverage report for the program.
 *
 * 
...
//Function to create the hard coded board
/*Parameters:
...
{    // Create a hard coded instance array of objectTrait
    ...
    //Index variable to track current position of the hard coded array of pairs
    int index = 0;
    //Run through each index row and column
    for (int r = 0; r < SIZE; r++) {
        for (int c = 0; c < SIZE; c++) {
            //Get trait and object for current pair
...
int main() {
    ...
    //Run game twice as test script runs a winning version and a losing version in one test
